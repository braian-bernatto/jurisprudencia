...
const Entidad = () => {
  return (
    <div className='rounded-md bg-white dark:bg-gray-700 shadow-md p-3 max-w-xs flex flex-col items-center justify-center gap-1 text-xs cursor-pointer hover:scale-110 transition-transform overflow-x-auto dark:shadow-gray-800'>
